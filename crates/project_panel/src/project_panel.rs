        ...
        div()
            ...
            .child(
                ListItem::new(id)
                    ...
                    .when(
                        details.chevron.is_none() && show_folder_arrows && show_folder_icons && !kind.is_dir(),
                        |this| {
                            this.child(
                                h_flex()
                    ...
                    .when(icon.is_some() || details.chevron.is_none(), |this| {
    ...
    fn details_for_entry(
        ...
        let (show_file_icons, show_folder_icons, show_folder_arrows) = {
            ...
            (
                ...
                settings.folder_arrows || !settings.folder_icons,
            )
        };
